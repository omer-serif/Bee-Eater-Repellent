...
url="https://search.macaulaylibrary.org/catalog?taxonCode=blakit1&mediaType=audio"
...
for i in range(len(divs)-1):
    ...
    for i in range(3):
        ...
        masaustu_klasoru = os.path.join(os.path.expanduser("~"), "Desktop", "yazLab", "kuşSesleri", "karaŞahin")
        dosya_yolu = os.path.join(masaustu_klasoru, str(dosyaSayisi) + ".KaraŞahin.mp3")
        dosyaSayisi += 1
        response = requests.get(indirilecekLink)

...
url="https://search.macaulaylibrary.org/catalog?taxonCode=larhac2&mediaType=audio"
...
for i in range(len(divs)-1):
    ...
    for i in range(3):
        ...
        if link2 is None:
            ...
            masaustu_klasoru = os.path.join(os.path.expanduser("~"), "Desktop", "yazLab", "kuşSesleri", "bayağıŞahin")
            dosya_yolu = os.path.join(masaustu_klasoru, str(dosyaSayisi) + ".bayağıŞahin.mp3")
            dosyaSayisi += 1
            response = requests.get(indirilecekLink)
